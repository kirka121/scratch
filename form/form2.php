...
<form enctype="multipart/form-data" action="" id="si_contact_form2" method="post">
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_2">
            First Name
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_3">
            Last Name
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_6">
            Province
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_7">
            Postal Code
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_8">
            Phone
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_9">
            Email
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_10">
            Native Language
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        ...
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_1" name="si_contact_ex_field11_1" value="selected"  />
        <label for="si_contact_ex_field2_11_1">Arabic</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_2" name="si_contact_ex_field11_2" value="selected"  />
        <label for="si_contact_ex_field2_11_2">Chinese</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_3" name="si_contact_ex_field11_3" value="selected"  />
        <label for="si_contact_ex_field2_11_3">English</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_4" name="si_contact_ex_field11_4" value="selected"  />
        <label for="si_contact_ex_field2_11_4">French</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_5" name="si_contact_ex_field11_5" value="selected"  />
        <label for="si_contact_ex_field2_11_5">German</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_6" name="si_contact_ex_field11_6" value="selected"  />
        <label for="si_contact_ex_field2_11_6">Italian</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_7" name="si_contact_ex_field11_7" value="selected"  />
        <label for="si_contact_ex_field2_11_7">Japanese</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_8" name="si_contact_ex_field11_8" value="selected"  />
        <label for="si_contact_ex_field2_11_8">Polish</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_9" name="si_contact_ex_field11_9" value="selected"  />
        <label for="si_contact_ex_field2_11_9">Russian</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_10" name="si_contact_ex_field11_10" value="selected"  />
        <label for="si_contact_ex_field2_11_10">Spanish</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_11" name="si_contact_ex_field11_11" value="selected"  />
        <label for="si_contact_ex_field2_11_11">Ukrainian</label>
        <br />
        <input type="checkbox" id="si_contact_ex_field2_11_12" name="si_contact_ex_field11_12" value="selected"  />
        <label for="si_contact_ex_field2_11_12">Other</label>

    </div>

    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_12">
            Education
            <span class="required">*</span>
        </label>
    </div>
    ...
    <div style="text-align:left; padding-top:5px;">
        <label for="si_contact_ex_field2_13">
            Attach Your Resume
            <span class="required">*</span>
        </label>
        <br />
        <small>
            (Acceptable file types: doc,docx,rtf,pdf,txt. Maximum file size: 2mb)
        </small>
