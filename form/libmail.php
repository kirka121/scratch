...
кодировку теперь нужно указывать не в теле письма как было раньше, а при инициализации класса например $m= new Mail('utf-8');
если не указывать кодировку, по умолчанию будет utf-8
--
