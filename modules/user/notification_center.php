<link rel="stylesheet" href="assets/css/user/notification_center.css">

<table id="my_settings_container">
	<tr>
		<th colspan="100%">Your Notifications</th>
	</tr>
	<tr>
		<td class="gigs">
	...
	<tr>
		<td class="left_padding">
			<p class="submit_button">
		      <input type="hidden" name="sub_update_notifications" value="1">
