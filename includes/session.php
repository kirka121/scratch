...
class Session
{
    ...
    */
   function register($subuser, $subpass, $subemail, $subfirstname, $sublastname){
      ...
      $field = "firstname";
        /* Check if firstname is already in use */
        if(strlen($subfirstname) < 2){
      ...
      $field = "lastname";
        /* Check if lastname is already in use */
        if(strlen($sublastname) < 2){
      ...
      /* No errors, add the new account to the */
         ...
         if($database->addNewUser($subuser, md5($subpass), $subemail, $subfirstname, $sublastname)){
            if(EMAIL_WELCOME){
               $mailer->sendWelcome($subuser,$subemail,$subpass, $subfirstname, $sublastname);
            }
